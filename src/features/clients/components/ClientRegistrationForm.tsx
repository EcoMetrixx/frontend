...
import { ArrowLeft, Check, CheckCircle2, ClipboardCheck, LoaderCircle, ArrowRight, X } from "lucide-react";
                ...
                <div className={styles.progressContainer}>
                    {steps.map((step, index) => (
                        <div key={step.id} className={styles.progressStep}>
                            ...
                            >
                                {index < currentStep ? <CheckCircle2 className={styles.buttonIcon} /> : index + 1}
                            </div>
                            <span
                            ...
                            {index < steps.length - 1 && (
                                <div
                                    className={`${styles.stepConnector} ${index < currentStep
                ...
                <div className={styles.formCard}>
                            ...
                            <div className={styles.formGrid}>
                                <div className={`${styles.formField} ${styles.formFieldFull}`}>
                                    ...
                                    <div className={styles.employmentTypeGrid}>
                                        {(
                                            [
                                                { label: "Dependiente", value: "DEPENDIENTE", helper: "Trabajador con planilla" },
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`${styles.employmentTypeCard} ${isActive ? styles.employmentTypeCardActive : ""
                                                        }`}
                                                >
                                                    <span className={styles.employmentTypeLabel}>{option.label}</span>
                                                    <span className={styles.employmentTypeHelper}>{option.helper}</span>
                                                </button>
                                            );
                                        })}
                                    </div>
                                ...
                                <div className={`${styles.formField} ${styles.formFieldFull}`}>
                                    <label className={styles.formLabel}>Empresa / Ocupación</label>
                                    <input
                                        type="text"
                                        className={styles.formInput}
                                ...
                                <div className={styles.formField}>
                                    <label className={styles.formLabel}>Antigüedad Laboral</label>
                                    <select
                                        className={styles.formSelect}
                    ...
                    {!showFinalSuccess && currentStep === 2 && (
                        <>
                            ...
                            <div className={styles.formGrid}>
                                <div className={styles.formField}>
                                    <label className={styles.formLabel}>Ingreso Familiar Total (S/)</label>
                                    <input
                                        type="number"
                                        className={styles.formInput}
                                ...
                                <div className={styles.formField}>
                                    <label className={styles.formLabel}>Ahorros Disponibles (S/)</label>
                                    <input
                                        type="number"
                                        className={styles.formInput}
                                ...
                                <div className={styles.formField}>
                                    <label className={styles.formLabel}>Deudas Existentes (S/)</label>
                                    <input
                                        type="number"
                                        className={styles.formInput}
                                ...
                                <div className={`${styles.formField} ${styles.formFieldFull}`}>
                                    <label className={styles.formLabel}>Información Adicional</label>
                    ...
                    {!showFinalSuccess && currentStep === 3 && (
                        <>
                            <div className={styles.sectionHeader}>
                                <h2 className={styles.sectionTitle}>Evaluación de Elegibilidad</h2>
                                <p className={styles.sectionSubtitle}>
                            ...
                            {evaluationStatus !== "completed" ? (
                                <div className="flex items-center gap-3 rounded-xl border-2 border-blue-200 bg-blue-50 px-6 py-4">
                                    ...
                                    <p className="text-sm font-semibold text-blue-700">Evaluando elegibilidad...</p>
                                </div>
                            ) : (
                                <div className="space-y-5">
                                    ...
                                    <div className="rounded-xl border border-slate-200 bg-white p-5">
                                        <p className="text-sm font-semibold text-slate-900 mb-4">Resumen del Cliente</p>
                                        <dl className="grid gap-4 md:grid-cols-2">
                                            <div>
                                                <dt className="text-xs uppercase tracking-wide text-slate-400 mb-1">Nombre</dt>
                                                <dd className="text-sm font-medium text-slate-900">{summary.fullName}</dd>
                                            </div>
                                            <div>
                                                <dt className="text-xs uppercase tracking-wide text-slate-400 mb-1">DNI</dt>
                                                <dd className="text-sm font-medium text-slate-900">{summary.dni}</dd>
                                            </div>
                                            <div>
                                                <dt className="text-xs uppercase tracking-wide text-slate-400 mb-1">Ingreso Familiar</dt>
                                                <dd className="text-sm font-medium text-slate-900">{summary.income}</dd>
                                            </div>
                                            <div>
                                                <dt className="text-xs uppercase tracking-wide text-slate-400 mb-1">Primera Vivienda</dt>
                        ...
                        <div className={styles.actionButtonsContainer}>
                            ...
                            <div className={styles.actionButtonsRight}>
                                ...
                                <button
                                    ...
                                    className={`${styles.button} ${canFinish ? "" : styles.buttonNext}`}
                                    style={canFinish ? { backgroundColor: "#10b981" } : undefined}
                                >
                                    {canFinish && <Check className={styles.buttonIcon} />}
                                    {nextButtonLabel}
                                    {!isLastStep && !canFinish && <ArrowRight className={styles.buttonIcon} />}
                                </button>
                            </div>
                        </div>
                    )}
